Scriptname ET_BloodPoolMeterWidget Extends SKI_WidgetBase

GlobalVariable Property ET_BloodPoolMeterScale Auto
...
GlobalVariable Property ET_VampireStagesMeterController Auto
...
int property PrimaryColor
	...
	int function get()
;		if ET_VampireStagesMeterController.GetValue() == 1
;			_primaryColor	= 11141120
;		elseif ET_VampireStagesMeterController.GetValue() == 2
;			_primaryColor	= 6553600
;		elseif ET_VampireStagesMeterController.GetValue() == 3
...
string function GetWidgetType()
 return "ET_BloodPoolMeterWidget"
endFunction
